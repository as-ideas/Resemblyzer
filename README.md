This package is forked from  https://github.com/resemble-ai/Resemblyzer, original package: https://pypi.org/project/Resemblyzer 
...
N.B.: this repo holds 100mb of audio data for demonstration purpose. To get [the package](https://pypi.org/project/Resemblyzer-Ideas/) alone, run `pip install resemblyzer-ideas` (python 3.5+ is required).
